...
`python3 downloader.py --url "https://www.youtube.com/" --target "videos" --buttonselector "12345" --filename "new-video`"

Opens Chrome browser at YouTube main page, clicks on a HTML element with CSS selector of `12345`, downloads a file to `videos` folder (relative to script location) and renames this downloaded file as `new-video`.
